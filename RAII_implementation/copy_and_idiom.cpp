...
class HolderNewGen{
	...
	public:
		...
		HolderNewGen(const HolderNewGen& other) {
			cout<<"Copy Constructor of HolderNewGen class called::"<<endl;
		...
		//Move constructor
		HolderNewGen(HolderNewGen&& other) {
			cout<<"Move Constructor of HolderNewGen class called::"<<endl;
			HolderNewGen();
			swap(*this, other);
		}
		...
		HolderNewGen& operator=(HolderNewGen&& other) {
			cout<<"Move assignment of HolderNewGen class called::"<<endl;
			swap(*this, other);
			return *this;
		}
		...
		HolderNewGen& operator=(HolderNewGen other){
			cout<<"Copy assignment of HolderNewGen class called::"<<endl;
   			swap(*this, other);
    		return *this;
		}
...
int main() {
	...
	h5 = h6; //Assingment Operator;
	HolderNewGen h2(std::move(h1));
	return 0;
}